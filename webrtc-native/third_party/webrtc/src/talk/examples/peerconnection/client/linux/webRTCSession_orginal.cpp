...
//	this->updateIceServers();
 printf(" webRTCSession::start() pc_factory =%p this =%p\n",(void *)pc_factory,this);
 printf(" webRTCSession::start() pc_factory =%p this =%p \n",(void *)&pc_factory,this);
}
...
//rtc::scoped_refptr<webrtc::PeerConnectionInterface> pc_;
    ...
    fake_constraints.AddOptional(webrtc::MediaConstraintsInterface::kEnableDtlsSrtp,
                            "false");
     fake_constraints.AddOptional(webrtc::MediaConstraintsInterface::kVeryHighBitrate,
                            "true");
      fake_constraints.AddOptional(webrtc::MediaConstraintsInterface::kCpuOveruseDetection,
                            "true");
       fake_constraints.AddOptional(webrtc::MediaConstraintsInterface::kCpuOveruseThreshold,
                            "350");
       fake_constraints.AddOptional(webrtc::MediaConstraintsInterface::kCpuUnderuseThreshold,
                            "150");
;
      fake_constraints.AddOptional(webrtc::MediaConstraintsInterface::kHighStartBitrate,
                            "true");
...
//	talk_base::scoped_refptr<webrtc::VideoTrackInterface> video_track(factory->CreateVideoTrack(kVideoLabel, source));
	 webrtc::FakeConstraints fake_constraints;
         fake_constraints.AddOptional(webrtc::MediaConstraintsInterface::kMinWidth,
                            "640");
         fake_constraints.AddOptional(webrtc::MediaConstraintsInterface::kMinHeight,
                            "480");
         fake_constraints.AddOptional(webrtc::MediaConstraintsInterface::kMinFrameRate,
                            "15");
...
std::string webRTCSession::preferCodec(std::string sdpDescription,string codec)
{
 ...
 //string lines[]= 
 boost::split(lines,sdpDescription,"\r\n");
       ...
       if (q > 3) {
         //   StringBuilder newMLine = new StringBuilder();
           ...
           for (; origPartIndex < q; origPartIndex++) {
               ...
               if (!temp1[origPartIndex].compare(*codecRtpMap)) {
