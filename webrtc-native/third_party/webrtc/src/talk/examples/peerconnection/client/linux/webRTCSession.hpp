...
//    void DummyOnSuccess(webrtc::SessionDescriptionInterface* desc); //gk
...
//    virtual void OnSignalingChange(PeerConnectionInterface::SignalingState new_state);
 //Shayo   virtual void OnIceConnectionChange(PeerConnectionInterface::IceConnectionState new_state);
    ...
    //virtual
    void OnIceGatheringChange(PeerConnectionInterface::IceGatheringState new_state);//Shayo
    ...
    virtual void OnRenegotiationNeeded();
	  ...
	  virtual void OnServerConnectionFailure();
       ...
       std::string preferCodec(std::string sdpDescription,string codec);
//Shayo private:
//protected://Shayo
   public:
    string target, alias;
