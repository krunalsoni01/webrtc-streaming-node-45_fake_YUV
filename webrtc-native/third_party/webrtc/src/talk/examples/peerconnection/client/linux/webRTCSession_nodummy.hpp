...
//    void setLocalVideoStream(rtc::scoped_refptr<webrtc::PeerConnectionInterface> pc, rtc::scoped_refptr<PeerConnectionFactoryInterface> factory);      // set local audio and video sources/ and send to peerconnection class
    ...
    //void DummyOnIceCandidate(const IceCandidateInterface* candidate); //gk
   ...
   virtual void OnIceConnectionChange(PeerConnectionInterface::IceConnectionState new_state);
    ...
    virtual void OnIceGatheringChange(PeerConnectionInterface::IceGatheringState new_state);//Shayo
