...
/*std::string sdp = "v=0o=- 1139636608282377988 2 IN IP4 127.0.0.1s=-t=0 0a=group:BUNDLE videoa=msid-semantic: WMS stream_labelm=video 9 RTP\/SAVPF 126 116 117 96c=IN IP4 0.0.0.0a=rtcp:9 IN IP4 0.0.0.0a=ice-ufrag:+RxhW\/WVj9Cgz+d6a=ice-pwd:Ir5ylCRW84jVzMHMjA5UBk8xa=fingerprint:sha-256 25:BB:7D:73:C8:EC:7A:42:16:6C:1B:38:6C:C7:52:20:96:9C:02:FF:3C:24:D5:D1:46:87:67:05:97:20:40:A8a=setup:actpassa=mid:videoa=extmap:2 urn:ietf:params:rtp-hdrext:toffseta=extmap:3 http:\/\/www.webrtc.org\/experiments\/rtp-hdrext\/abs-send-timea=extmap:4 urn:3gpp:video-orientationa=sendonlya=rtcp-muxa=rtpmap:126 H264\/90000a=rtcp-fb:126 ccm fira=rtcp-fb:126 nacka=rtcp-fb:126 nack plia=rtcp-fb:126 goog-remba=rtpmap:100 VP8\/90000a=rtcp-fb:100 ccm fira=rtcp-fb:100 nacka=rtcp-fb:100 nack plia=rtcp-fb:100 goog-remba=rtpmap:116 red\/90000a=rtpmap:117 ulpfec\/90000a=rtpmap:96 rtx\/90000a=fmtp:96 apt=100a=ssrc-group:FID 649311749 761637788a=ssrc:649311749 cname:TrKGrP+ME3ySfjvPa=ssrc:649311749 msid:stream_label video_labela=ssrc:649311749 mslabel:stream_labela=ssrc:649311749 label:video_labela=ssrc:761637788 cname:TrKGrP+ME3ySfjvPa=ssrc:761637788 msid:stream_label video_labela=ssrc:761637788 mslabel:stream_labela=ssrc:761637788 label:video_label";
*/
std::string sdp; 
	desc->ToString(&sdp);
...
//preferCodec(sdp_vasu1, "H264");  //VASUDHA
      std::string sdp1 =preferCodec(sdp, "H264"); //gkFIXME
#endif
...
//boost::match_results result;
   ...
   if(origMLineParts.size() > 3)
   {
    ...
    {
if(origMLineParts[origPartIndex]!="100"){
