...
//rtc::scoped_refptr<webrtc::PeerConnectionInterface> pc_;
    ...
    fake_constraints.AddOptional(webrtc::MediaConstraintsInterface::kEnableDtlsSrtp,
                            "true");
//e                           "true");
//   fake_constraints.AddMandatory(webrtc::MediaConstraintsInterface::kOfferToReceiveAudio, webrtc::MediaConstraintsInterface::kValueFalse); //gk FIXME try Anand --trying to enable audio
...
#if 1 //gk FIXME remove audio for sercomm 
